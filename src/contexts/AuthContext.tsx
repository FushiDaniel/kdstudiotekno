...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // Remove automatic status tracking - users will manually update their status
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            setUser({
              ...
              isRejected: userData.isRejected || false,
              rejectedAt: userData.rejectedAt?.toDate(),
              rejectionReason: userData.rejectionReason,
              rejectedBy: userData.rejectedBy,
              rejectedByName: userData.rejectedByName,
              rejectedByStaffId: userData.rejectedByStaffId,
